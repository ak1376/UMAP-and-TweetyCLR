...
noise_level = 10.0
train_dataset = APP_MATCHER(dataset, train_hard_dataset, hard_indices, embed_train, noise_scale = noise_level)   
test_dataset = APP_MATCHER(dataset, test_hard_dataset, hard_indices, embed_test, noise_scale = noise_level)   
